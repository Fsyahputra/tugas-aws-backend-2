...
describe("UserRepositoryPostgres", () => {
  ...
  describe("mustExistOrThrowById function", () => {
    it("should throw InvariantError when user not found", async () => {
      // Arrange
      // @ts-expect-error
      const userRepositoryPostgres = new UserRepositoryPostgres(pool, {});
      ...
      // Action & Assert
      await expect(
        userRepositoryPostgres.mustExistOrThrowById("user-123"),
      ).rejects.toThrowError(InvariantError);
    });

    it("should not throw InvariantError when user is found", async () => {
      // Arrange
  ...
  describe("getUserById function", () => {
    it("should return user correctly", async () => {
      ...
      const registeredUser =
        await userRepositoryPostgres.getUserById("user-123");
      // Assert
      expect(registeredUser).toStrictEqual(
        new RegisteredUser({
          id: "user-123",
