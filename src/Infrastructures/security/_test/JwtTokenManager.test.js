...
describe("JwtTokenManager", () => {
  ...
  describe("decodePayload function", () => {
    ...
    it("should throw AuthenticationError when decode payload failed", async () => {
      // Arrange
      const jwtTokenManager = new JwtTokenManager(Jwt.token);
      const invalidAccessToken = "this_is_invalid_token";

      // Action & Assert
      await expect(
        jwtTokenManager.decodePayload(invalidAccessToken),
      ).rejects.toThrowError("akses token tidak valid");
    });
  });
});
